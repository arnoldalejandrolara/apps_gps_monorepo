...
export { getLast5Routes, sendComando, goStreetView, getRouteToday, getDatosDispositivo, updateDatosDispositivo } from './dispositivos/index.js';
...
export { getMarcasUnidades, getTiposUnidades } from './unidades/index.js';